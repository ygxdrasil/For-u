 ...
 * Discriminator: resource=message, operation=sendHtml
 */
...
/** Send a message */
export type MandrillV1MessageSendHtmlParams = {
  resource: 'message';
  operation: 'sendHtml';
/**
...
export type MandrillV1MessageSendHtmlNode = {
  type: 'n8n-nodes-base.mandrill';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<MandrillV1MessageSendHtmlParams>;
  output?: Items<MandrillV1MessageSendHtmlOutput>;
};