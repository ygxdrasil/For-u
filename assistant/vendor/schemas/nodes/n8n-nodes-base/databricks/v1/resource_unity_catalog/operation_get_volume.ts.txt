 ...
 * Discriminator: resource=unityCatalog, operation=getVolume
 */
...
export type DatabricksV1UnityCatalogGetVolumeParams = {
...
export type DatabricksV1UnityCatalogGetVolumeNode = {
  type: 'n8n-nodes-base.databricks';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<DatabricksV1UnityCatalogGetVolumeParams>;
};