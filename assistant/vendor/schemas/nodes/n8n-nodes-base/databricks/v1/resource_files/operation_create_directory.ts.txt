 ...
 * Discriminator: resource=files, operation=createDirectory
 */
...
export type DatabricksV1FilesCreateDirectoryParams = {
  resource: 'files';
...
export type DatabricksV1FilesCreateDirectoryNode = {
  type: 'n8n-nodes-base.databricks';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<DatabricksV1FilesCreateDirectoryParams>;
};