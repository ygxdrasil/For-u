 ...
 * Discriminator: resource=files, operation=deleteFile
 */
...
export type DatabricksV1FilesDeleteFileParams = {
  resource: 'files';
...
export type DatabricksV1FilesDeleteFileNode = {
  type: 'n8n-nodes-base.databricks';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<DatabricksV1FilesDeleteFileParams>;
};