 ...
 * Discriminator: resource=purchaseOrder, operation=create
 */
...
/** Create an account */
export type ZohoCrmV1PurchaseOrderCreateParams = {
 ...
 */
    ...
    /** Discount applied to the purchase order. For example, enter 12 for 12%.
     * @default 0
     */
...
export type ZohoCrmV1PurchaseOrderCreateNode = {
  type: 'n8n-nodes-base.zohoCrm';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<ZohoCrmV1PurchaseOrderCreateParams>;
};