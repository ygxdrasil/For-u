 ...
 * Discriminator: resource=purchaseOrder, operation=getAll
 */
...
/** Get many accounts */
export type ZohoCrmV1PurchaseOrderGetAllParams = {
...
export type ZohoCrmV1PurchaseOrderGetAllNode = {
  type: 'n8n-nodes-base.zohoCrm';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<ZohoCrmV1PurchaseOrderGetAllParams>;
};