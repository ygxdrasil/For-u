 ...
 * Discriminator: resource=salesOrder, operation=upsert
 */
...
export type ZohoCrmV1SalesOrderUpsertParams = {
  resource: 'salesOrder';
  operation: 'upsert';
/**
...
export type ZohoCrmV1SalesOrderUpsertNode = {
  type: 'n8n-nodes-base.zohoCrm';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<ZohoCrmV1SalesOrderUpsertParams>;
};