 ...
 * Discriminator: resource=salesOrder, operation=update
 */
...
/** Update an account */
export type ZohoCrmV1SalesOrderUpdateParams = {
  resource: 'salesOrder';
  operation: 'update';
/**
...
export type ZohoCrmV1SalesOrderUpdateNode = {
  type: 'n8n-nodes-base.zohoCrm';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<ZohoCrmV1SalesOrderUpdateParams>;
};