 ...
 * Discriminator: resource=deal, operation=upsert
 */
...
export type ZohoCrmV1DealUpsertParams = {
  resource: 'deal';
  operation: 'upsert';
/**
...
export type ZohoCrmV1DealUpsertNode = {
  type: 'n8n-nodes-base.zohoCrm';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<ZohoCrmV1DealUpsertParams>;
};