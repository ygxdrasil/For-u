...
export type MicrosoftDynamicsCrmV1AccountCreateParams = {
  resource: 'account';
  operation: 'create';
/**
...
export type MicrosoftDynamicsCrmV1AccountCreateNode = {
  type: 'n8n-nodes-base.microsoftDynamicsCrm';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftDynamicsCrmV1AccountCreateParams>;
};