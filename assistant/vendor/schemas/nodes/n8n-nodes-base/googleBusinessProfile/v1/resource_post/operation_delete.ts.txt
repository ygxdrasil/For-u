...
export type GoogleBusinessProfileV1PostDeleteParams = {
  resource: 'post';
  operation: 'delete';
/**
...
export type GoogleBusinessProfileV1PostDeleteNode = {
  type: 'n8n-nodes-base.googleBusinessProfile';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoogleBusinessProfileV1PostDeleteParams>;
};