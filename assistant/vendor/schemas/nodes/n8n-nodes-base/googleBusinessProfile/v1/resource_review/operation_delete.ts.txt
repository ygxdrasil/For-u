 ...
 * Discriminator: resource=review, operation=delete
 */
...
export type GoogleBusinessProfileV1ReviewDeleteParams = {
  resource: 'review';
  operation: 'delete';
/**
...
export type GoogleBusinessProfileV1ReviewDeleteNode = {
  type: 'n8n-nodes-base.googleBusinessProfile';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoogleBusinessProfileV1ReviewDeleteParams>;
};