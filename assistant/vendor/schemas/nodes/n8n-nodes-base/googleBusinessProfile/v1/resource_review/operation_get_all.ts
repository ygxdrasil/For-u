...
export type GoogleBusinessProfileV1ReviewGetAllParams = {
  resource: 'review';
  operation: 'getAll';
/**
...
export type GoogleBusinessProfileV1ReviewGetAllOutput = {
  comment?: string;
  createTime?: string;
  name?: string;
  reviewer?: {
...
export type GoogleBusinessProfileV1ReviewGetAllNode = {
  type: 'n8n-nodes-base.googleBusinessProfile';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoogleBusinessProfileV1ReviewGetAllParams>;
  output?: Items<GoogleBusinessProfileV1ReviewGetAllOutput>;
};