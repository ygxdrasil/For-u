/**
 * Mattermost - Message Resource - Zod Schema Factory
...
const getPostEphemeralSchema = require('./operation_post_ephemeral.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getPostEphemeralSchema({ ...helpers, parameters: effectiveParams }),
  ]);
};