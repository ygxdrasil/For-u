 ...
 * Discriminator: resource=chatMessage, operation=sendAndWait
 */
...
export type MicrosoftTeamsV2ChatMessageSendAndWaitParams = {
...
export type MicrosoftTeamsV2ChatMessageSendAndWaitOutput = {
  data?: {
    approved?: boolean;
  };
};

export type MicrosoftTeamsV2ChatMessageSendAndWaitNode = {
  type: 'n8n-nodes-base.microsoftTeams';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftTeamsV2ChatMessageSendAndWaitParams>;
  output?: Items<MicrosoftTeamsV2ChatMessageSendAndWaitOutput>;
};