/**
 * X (Formerly Twitter) - Tweet Resource - Zod Schema Factory
...
const getLikeSchema = require('./operation_like.schema');
const getRetweetSchema = require('./operation_retweet.schema');
