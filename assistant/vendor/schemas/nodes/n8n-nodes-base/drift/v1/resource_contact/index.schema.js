/**
 * Drift - Contact Resource - Zod Schema Factory
...
const getGetCustomAttributesSchema = require('./operation_get_custom_attributes.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getGetCustomAttributesSchema({ ...helpers, parameters: effectiveParams }),
