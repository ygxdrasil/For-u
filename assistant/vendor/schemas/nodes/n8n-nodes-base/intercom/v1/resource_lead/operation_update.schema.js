...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      updateBy: z.union([z.literal('userId'), z.literal('id'), expressionSchema]).optional(),
      value: stringOrExpression.optional(),
      jsonParameters: booleanOrExpression.optional(),
      additionalFields: z.object({ avatar: stringOrExpression.optional(), companies: z.array(z.string()).optional(), email: stringOrExpression.optional(), name: stringOrExpression.optional(), phone: stringOrExpression.optional(), unsubscribedFromEmails: booleanOrExpression.optional(), updateLastRequestAt: booleanOrExpression.optional(), utmCampaign: stringOrExpression.optional(), utmContent: stringOrExpression.optional(), utmMedium: stringOrExpression.optional(), utmSource: stringOrExpression.optional(), utmTerm: stringOrExpression.optional() }).optional(),
