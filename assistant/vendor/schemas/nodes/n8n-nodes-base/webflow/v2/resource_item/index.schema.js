/**
 * Webflow - Item Resource - Zod Schema Factory
...
const getDeleteItemSchema = require('./operation_delete_item.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getDeleteItemSchema({ ...helpers, parameters: effectiveParams }),
