/**
 * Postgres Node - Version 2.1 - Zod Validation Schemas
 *
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema }) {
  ...
  const parametersSchema = z.object({
    ...
    restartSequences: resolveSchema({ parameters, schema: booleanOrExpression, required: false, displayOptions: {"show":{"deleteCommand":["truncate"],"resource":["database"],"operation":["deleteTable"]},"hide":{"table":[""]}}, defaults: {"deleteCommand":"truncate","resource":"database","operation":"insert","table":{"mode":"list","value":""}} }),
    ...
    options: resolveSchema({ parameters, schema: z.object({ cascade: booleanOrExpression.optional(), connectionTimeout: numberOrExpression.optional(), delayClosingIdleConnection: numberOrExpression.optional(), queryBatching: z.union([z.literal('single'), z.literal('independently'), z.literal('transaction')]).optional(), queryReplacement: stringOrExpression.optional(), treatQueryParametersInSingleQuotesAsText: booleanOrExpression.optional(), outputColumns: z.array(z.string()).optional(), largeNumbersOutput: z.union([z.literal('numbers'), z.literal('text'), expressionSchema]).optional(), skipOnConflict: booleanOrExpression.optional(), replaceEmptyStrings: booleanOrExpression.optional() }), required: false, displayOptions: {"show":{"resource":["database"],"operation":["deleteTable","executeQuery","insert","select","update","upsert"]},"hide":{"table":[""]}}, defaults: {"resource":"database","operation":"insert","table":{"mode":"list","value":""}} }),
