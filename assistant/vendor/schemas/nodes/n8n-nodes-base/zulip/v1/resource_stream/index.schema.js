/**
 * Zulip - Stream Resource - Zod Schema Factory
...
const getGetSubscribedSchema = require('./operation_get_subscribed.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getGetSubscribedSchema({ ...helpers, parameters: effectiveParams }),
