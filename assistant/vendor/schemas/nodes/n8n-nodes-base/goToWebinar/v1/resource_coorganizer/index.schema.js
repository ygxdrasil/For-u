/**
 * GoToWebinar - Coorganizer Resource - Zod Schema Factory
...
const getReinviteSchema = require('./operation_reinvite.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getReinviteSchema({ ...helpers, parameters: effectiveParams }),
  ]);
};