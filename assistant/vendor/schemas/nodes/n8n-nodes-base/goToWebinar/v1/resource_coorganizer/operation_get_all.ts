 ...
 * Discriminator: resource=coorganizer, operation=getAll
 */
...
export type GoToWebinarV1CoorganizerGetAllParams = {
...
export type GoToWebinarV1CoorganizerGetAllNode = {
  type: 'n8n-nodes-base.goToWebinar';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoToWebinarV1CoorganizerGetAllParams>;
};