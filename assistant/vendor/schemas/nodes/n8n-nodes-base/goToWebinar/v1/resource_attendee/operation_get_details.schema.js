...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema }) {
  ...
  return z.object({
    parameters: z.object({
      resource: z.literal('attendee').default('attendee'),
      operation: z.literal('getDetails'),
      webinarKey: stringOrExpression.optional(),
      sessionKey: stringOrExpression.optional(),
      registrantKey: stringOrExpression.optional(),
      details: z.union([z.literal('polls'), z.literal('questions'), z.literal('surveyAnswers'), expressionSchema]).optional(),
    }).optional(),
  });
};