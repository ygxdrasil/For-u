...
/** Update an order */
export type ShopifyV1ProductUpdateParams = {
  resource: 'product';
  operation: 'update';
...
export type ShopifyV1ProductUpdateNode = {
  type: 'n8n-nodes-base.shopify';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<ShopifyV1ProductUpdateParams>;
  output?: Items<ShopifyV1ProductUpdateOutput>;
};