/**
 * Evaluation Trigger Node - Version 4.7 - Zod Validation Schemas
 *
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema }) {
  ...
  const parametersSchema = z.object({
    ...
    filtersUI: resolveSchema({ parameters, schema: z.object({ values: z.array(z.object({ lookupColumn: stringOrExpression.optional(), lookupValue: stringOrExpression.optional() })).optional() }), required: false, displayOptions: {"hide":{"source":["dataTable"]}}, defaults: {"source":"dataTable"} }),
    filterRows: resolveSchema({ parameters, schema: z.boolean(), required: false, displayOptions: {"show":{"source":["dataTable"]}}, defaults: {"source":"dataTable"} }),
