...
export type MicrosoftExcelV22WorksheetUpdateParams = {
  resource: 'worksheet';
  operation: 'update';
/**
 * Workbook
 ...
 * @displayOptions.show { dataMode: ["autoMap", "define", "raw"], useRange: [true] }
 */
...
export type MicrosoftExcelV22WorksheetUpdateNode = {
  type: 'n8n-nodes-base.microsoftExcel';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftExcelV22WorksheetUpdateParams>;
};