 ...
 * Discriminator: resource=album, operation=getNewReleases
 */
...
export type SpotifyV1AlbumGetNewReleasesParams = {
  resource: 'album';
 ...
 */
    filters?: {
    /** Country to filter new releases by
     * @default US
     */
...
export type SpotifyV1AlbumGetNewReleasesNode = {
  type: 'n8n-nodes-base.spotify';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<SpotifyV1AlbumGetNewReleasesParams>;
};