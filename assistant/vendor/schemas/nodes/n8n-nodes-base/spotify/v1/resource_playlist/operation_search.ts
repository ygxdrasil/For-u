 ...
 * Discriminator: resource=playlist, operation=search
 */
...
export type SpotifyV1PlaylistSearchParams = {
  resource: 'playlist';
  operation: 'search';
/**
...
export type SpotifyV1PlaylistSearchNode = {
  type: 'n8n-nodes-base.spotify';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<SpotifyV1PlaylistSearchParams>;
  output?: Items<SpotifyV1PlaylistSearchOutput>;
};