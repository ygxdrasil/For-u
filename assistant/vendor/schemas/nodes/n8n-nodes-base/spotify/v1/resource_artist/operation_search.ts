 ...
 * Discriminator: resource=artist, operation=search
 */
...
export type SpotifyV1ArtistSearchParams = {
  resource: 'artist';
  operation: 'search';
/**
...
export type SpotifyV1ArtistSearchNode = {
  type: 'n8n-nodes-base.spotify';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<SpotifyV1ArtistSearchParams>;
  output?: Items<SpotifyV1ArtistSearchOutput>;
};