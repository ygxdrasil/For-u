 ...
 * Discriminator: resource=track, operation=search
 */
...
export type SpotifyV1TrackSearchParams = {
  resource: 'track';
  operation: 'search';
/**
...
export type SpotifyV1TrackSearchNode = {
  type: 'n8n-nodes-base.spotify';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<SpotifyV1TrackSearchParams>;
  output?: Items<SpotifyV1TrackSearchOutput>;
};