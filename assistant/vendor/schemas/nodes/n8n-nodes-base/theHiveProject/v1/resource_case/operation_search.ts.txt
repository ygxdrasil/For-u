 ...
 * Discriminator: resource=case, operation=search
 */
...
export type TheHiveProjectV1CaseSearchParams = {
  resource: 'case';
  operation: 'search';
/**
...
export type TheHiveProjectV1CaseSearchNode = {
  type: 'n8n-nodes-base.theHiveProject';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TheHiveProjectV1CaseSearchParams>;
};