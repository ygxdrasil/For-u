...
export type TheHiveProjectV1ObservableSearchParams = {
  resource: 'observable';
  operation: 'search';
/**
...
export type TheHiveProjectV1ObservableSearchNode = {
  type: 'n8n-nodes-base.theHiveProject';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TheHiveProjectV1ObservableSearchParams>;
};