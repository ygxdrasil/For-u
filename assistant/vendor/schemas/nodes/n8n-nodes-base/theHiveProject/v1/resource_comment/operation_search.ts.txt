 ...
 * Discriminator: resource=comment, operation=search
 */
...
export type TheHiveProjectV1CommentSearchParams = {
  resource: 'comment';
  operation: 'search';
/**
...
export type TheHiveProjectV1CommentSearchNode = {
  type: 'n8n-nodes-base.theHiveProject';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TheHiveProjectV1CommentSearchParams>;
};