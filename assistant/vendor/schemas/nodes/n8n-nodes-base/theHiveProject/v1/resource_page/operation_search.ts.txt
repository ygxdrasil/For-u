...
export type TheHiveProjectV1PageSearchParams = {
  resource: 'page';
  operation: 'search';
/**
...
/**
 * Case
 * @displayOptions.show { searchInKnowledgeBase: [false] }
...
export type TheHiveProjectV1PageSearchNode = {
  type: 'n8n-nodes-base.theHiveProject';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TheHiveProjectV1PageSearchParams>;
};