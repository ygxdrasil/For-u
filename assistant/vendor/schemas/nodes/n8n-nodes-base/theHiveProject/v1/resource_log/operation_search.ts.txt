 ...
 * Discriminator: resource=log, operation=search
 */
...
export type TheHiveProjectV1LogSearchParams = {
  resource: 'log';
  operation: 'search';
/**
...
/**
 * Task
 * @displayOptions.show { allTasks: [false] }
...
export type TheHiveProjectV1LogSearchNode = {
  type: 'n8n-nodes-base.theHiveProject';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TheHiveProjectV1LogSearchParams>;
};