...
export type TheHiveProjectV1LogExecuteResponderParams = {
  resource: 'log';
...
export type TheHiveProjectV1LogExecuteResponderNode = {
  type: 'n8n-nodes-base.theHiveProject';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TheHiveProjectV1LogExecuteResponderParams>;
};