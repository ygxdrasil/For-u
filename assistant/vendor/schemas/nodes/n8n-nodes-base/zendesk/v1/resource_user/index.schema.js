/**
 * Zendesk - User Resource - Zod Schema Factory
...
const getGetOrganizationsSchema = require('./operation_get_organizations.schema');
const getGetRelatedDataSchema = require('./operation_get_related_data.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getGetOrganizationsSchema({ ...helpers, parameters: effectiveParams }),
    getGetRelatedDataSchema({ ...helpers, parameters: effectiveParams }),
