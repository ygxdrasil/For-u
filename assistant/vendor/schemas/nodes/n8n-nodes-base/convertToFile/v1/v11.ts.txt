 ...
 * @displayOptions.show { operation: ["csv", "html", "rtf", "ods", "xls", "xlsx", "toBinary", "toText", "toJson", "iCal"] }
 * @default data
 */
    binaryPropertyName?: string | Expression<string> | PlaceholderValue;
/**
 * Options
 * @displayOptions.show { operation: ["csv", "html", "rtf", "ods", "xls", "xlsx", "toBinary", "toText", "toJson"] }
 * @default {}
 */
    options?: {
 ...
 * @displayOptions.show { operation: ["toBinary", "toText"] }
 */
