...
/**
 * Options
 * @displayOptions.show { operation: ["addConfig", "commit", "log", "push", "reflog", "switchBranch"] }
 * @default {}
 */
    options?: {
 ...
 * @displayOptions.show { operation: ["log", "reflog"], returnAll: [false] }
 * @default 100
 */
...
export type GitV11ParamsNode = GitV11NodeBase & {
  config: NodeConfig<GitV11Params>;
};

export type GitV11Node = GitV11ParamsNode;