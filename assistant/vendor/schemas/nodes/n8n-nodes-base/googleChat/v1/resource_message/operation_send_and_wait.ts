...
export type GoogleChatV1MessageSendAndWaitParams = {
  resource: 'message';
...
export type GoogleChatV1MessageSendAndWaitOutput = {
  data?: {
    approved?: boolean;
    text?: string;
  };
...
export type GoogleChatV1MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.googleChat';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoogleChatV1MessageSendAndWaitParams>;
  output?: Items<GoogleChatV1MessageSendAndWaitOutput>;
};