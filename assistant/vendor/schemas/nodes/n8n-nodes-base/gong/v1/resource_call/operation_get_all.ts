/**
 * Gong Node - Version 1
 * Discriminator: resource=call, operation=getAll
 */
...
export type GongV1CallGetAllParams = {
  resource: 'call';
  operation: 'getAll';
 ...
 */
     ...
     */
    fromDateTime?: string | Expression<string>;
     ...
     */
    toDateTime?: string | Expression<string>;
    /** Return only the calls belonging to this workspace
     */
    workspaceId?: string | Expression<string> | PlaceholderValue;
    /** List of calls IDs to be filtered
     * @hint Comma separated list of IDs, array of strings can be set in expression
     */
    callIds?: string | Expression<string> | PlaceholderValue;
    /** Return only the calls hosted by the specified user
     * @default {"mode":"list","value":""}
     */
    primaryUserIds?: { __rl: true; mode: 'list' | 'id'; value: string; cachedResultName?: string };
  };
/**
 * Options
 * @default {}
 */
     ...
     * @default []
     */
    properties?: Array<'parties' | 'topics'>;
  };
  requestOptions?: {
    /** Batching
     * @default {"batch":{}}
...
export type GongV1CallGetAllNode = {
  type: 'n8n-nodes-base.gong';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GongV1CallGetAllParams>;
  output?: Items<GongV1CallGetAllOutput>;
};