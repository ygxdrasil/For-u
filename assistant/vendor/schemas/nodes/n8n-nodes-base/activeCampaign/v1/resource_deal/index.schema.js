/**
 * ActiveCampaign - Deal Resource - Zod Schema Factory
...
const getCreateNoteSchema = require('./operation_create_note.schema');
...
const getUpdateNoteSchema = require('./operation_update_note.schema');
