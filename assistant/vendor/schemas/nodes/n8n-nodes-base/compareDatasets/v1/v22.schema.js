/**
 * Compare Datasets Node - Version 2.2 - Zod Validation Schemas
 *
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema }) {
  ...
  const parametersSchema = z.object({
    ...
    preferWhenMix: resolveSchema({ parameters, schema: z.union([z.literal('input1'), z.literal('input2'), expressionSchema]), required: false, displayOptions: {"show":{"resolve":["mix"]}}, defaults: {"resolve":"includeBoth"} }),
    exceptWhenMix: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"resolve":["mix"]}}, defaults: {"resolve":"includeBoth"} }),
