 ...
 * Discriminator: resource=appointment, operation=create
 */
...
/** Create an account */
export type FreshworksCrmV1AppointmentCreateParams = {
...
export type FreshworksCrmV1AppointmentCreateNode = {
  type: 'n8n-nodes-base.freshworksCrm';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<FreshworksCrmV1AppointmentCreateParams>;
};