 ...
 * Discriminator: resource=appointment, operation=update
 */
...
/** Update an account */
export type FreshworksCrmV1AppointmentUpdateParams = {
 ...
 */
    ...
    /** Whether it is an all-day appointment or not
     * @default false
     */
    is_allday?: boolean | Expression<boolean>;
    /** Latitude of the location when you check in for an appointment
     */
    latitude?: string | Expression<string> | PlaceholderValue;
    /** Location of the appointment
     */
    location?: string | Expression<string> | PlaceholderValue;
    /** Longitude of the location when you check in for an appointment
     */
    ...
    /** ID of contact/account against whom appointment is created
     */
...
export type FreshworksCrmV1AppointmentUpdateNode = {
  type: 'n8n-nodes-base.freshworksCrm';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<FreshworksCrmV1AppointmentUpdateParams>;
};