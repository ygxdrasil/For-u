...
export type MicrosoftOutlookV2MessageGetAllParams = {
  resource: 'message';
  operation: 'getAll';
/**
...
export type MicrosoftOutlookV2MessageGetAllOutput = {
  '@odata.etag'?: string;
  body?: {
    content?: string;
    contentType?: string;
...
export type MicrosoftOutlookV2MessageGetAllNode = {
  type: 'n8n-nodes-base.microsoftOutlook';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftOutlookV2MessageGetAllParams>;
  output?: Items<MicrosoftOutlookV2MessageGetAllOutput>;
};