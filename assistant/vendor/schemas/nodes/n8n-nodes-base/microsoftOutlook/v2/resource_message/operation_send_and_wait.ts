...
export type MicrosoftOutlookV2MessageSendAndWaitParams = {
  resource: 'message';
...
export type MicrosoftOutlookV2MessageSendAndWaitOutput = {
  data?: {
    approved?: boolean;
    text?: string;
  };
...
export type MicrosoftOutlookV2MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.microsoftOutlook';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftOutlookV2MessageSendAndWaitParams>;
  output?: Items<MicrosoftOutlookV2MessageSendAndWaitOutput>;
};