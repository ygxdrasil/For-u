...
export type AwsCognitoV1UserRemoveFromGroupParams = {
  resource: 'user';
...
export type AwsCognitoV1UserRemoveFromGroupNode = {
  type: 'n8n-nodes-base.awsCognito';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<AwsCognitoV1UserRemoveFromGroupParams>;
};