/**
 * GraphQL Node - Version 1.1 - Zod Validation Schemas
 *
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema }) {
  ...
  const parametersSchema = z.object({
    ...
    requestFormat: resolveSchema({ parameters, schema: z.union([z.literal('json'), z.literal('graphql'), expressionSchema]), required: false, displayOptions: {"show":{"requestMethod":["POST"]}}, defaults: {"requestMethod":"POST"} }),
    query: stringOrExpression.optional(),
    variables: resolveSchema({ parameters, schema: z.union([iDataObjectSchema, z.string()]), required: false, displayOptions: {"show":{"requestFormat":["json"],"requestMethod":["POST"]}}, defaults: {"requestFormat":"json","requestMethod":"POST"} }),
    operationName: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"requestFormat":["json"],"requestMethod":["POST"]}}, defaults: {"requestFormat":"json","requestMethod":"POST"} }),
