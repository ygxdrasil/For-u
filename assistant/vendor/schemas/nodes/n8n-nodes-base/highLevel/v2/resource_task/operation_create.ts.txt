...
export type HighLevelV2TaskCreateParams = {
  resource: 'task';
  operation: 'create';
/**
...
export type HighLevelV2TaskCreateNode = {
  type: 'n8n-nodes-base.highLevel';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HighLevelV2TaskCreateParams>;
  output?: Items<HighLevelV2TaskCreateOutput>;
};