...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      additionalFields: z.object({ assigneeId: stringOrExpression.optional(), description: stringOrExpression.optional(), priorityId: z.union([z.literal(1), z.literal(2), z.literal(3), z.literal(4), z.literal(0), expressionSchema]).optional(), stateId: stringOrExpression.optional() }).optional(),
    }).optional(),
  });
};