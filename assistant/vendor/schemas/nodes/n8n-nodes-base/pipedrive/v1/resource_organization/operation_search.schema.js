...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      additionalFields: z.object({ exactMatch: booleanOrExpression.optional(), fields: z.array(z.union([z.literal('address'), z.literal('custom_fields'), z.literal('name'), z.literal('notes')])).optional(), rawData: booleanOrExpression.optional() }).optional(),
    }).optional(),
  });
};