...
export interface FormTriggerV2Params {
...
export type FormTriggerV2ParamsNode = FormTriggerV2NodeBase & {
  config: NodeConfig<FormTriggerV2Params>;
};

export type FormTriggerV2Node = FormTriggerV2ParamsNode;