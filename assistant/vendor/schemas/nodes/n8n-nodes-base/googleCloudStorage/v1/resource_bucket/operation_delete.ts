...
export type GoogleCloudStorageV1BucketDeleteParams = {
  resource: 'bucket';
  operation: 'delete';
/**
 * Bucket Name
...
export type GoogleCloudStorageV1BucketDeleteNode = {
  type: 'n8n-nodes-base.googleCloudStorage';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoogleCloudStorageV1BucketDeleteParams>;
};