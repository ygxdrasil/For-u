 ...
 */
    fileId?: { __rl: true; mode: 'url' | 'id'; value: string; cachedResultName?: string };
/**
 ...
 */
    folderId?: { __rl: true; mode: 'url' | 'id'; value: string; cachedResultName?: string };
/**
 * Options
 * @displayOptions.show { watch: ["selectedFolder"] }
 * @default {}
 */
    options?: {
     ...
     * @default false
     */
    folderChild?: boolean | Expression<boolean>;
  };
}
