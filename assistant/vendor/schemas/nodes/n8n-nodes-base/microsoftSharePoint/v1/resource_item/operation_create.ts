...
export type MicrosoftSharePointV1ItemCreateParams = {
  resource: 'item';
  operation: 'create';
/**
...
export type MicrosoftSharePointV1ItemCreateNode = {
  type: 'n8n-nodes-base.microsoftSharePoint';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftSharePointV1ItemCreateParams>;
};