...
export type MicrosoftSharePointV1ListGetParams = {
  resource: 'list';
  operation: 'get';
/**
...
export type MicrosoftSharePointV1ListGetOutput = {
...
export type MicrosoftSharePointV1ListGetNode = {
  type: 'n8n-nodes-base.microsoftSharePoint';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftSharePointV1ListGetParams>;
  output?: Items<MicrosoftSharePointV1ListGetOutput>;
};