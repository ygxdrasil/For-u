...
/** Download a file */
export type MicrosoftSharePointV1FileDownloadParams = {
  resource: 'file';
  operation: 'download';
/**
...
export type MicrosoftSharePointV1FileDownloadNode = {
  type: 'n8n-nodes-base.microsoftSharePoint';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftSharePointV1FileDownloadParams>;
};