/**
 * Splunk - User Resource - Zod Schema Factory
...
const getDeleteUserSchema = require('./operation_delete_user.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getDeleteUserSchema({ ...helpers, parameters: effectiveParams }),
