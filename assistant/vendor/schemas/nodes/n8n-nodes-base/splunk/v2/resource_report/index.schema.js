/**
 * Splunk - Report Resource - Zod Schema Factory
...
const getDeleteReportSchema = require('./operation_delete_report.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getDeleteReportSchema({ ...helpers, parameters: effectiveParams }),
