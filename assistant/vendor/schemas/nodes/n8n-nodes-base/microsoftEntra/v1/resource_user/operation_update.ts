...
/** Update a group */
export type MicrosoftEntraV1UserUpdateParams = {
  resource: 'user';
  operation: 'update';
/**
 * User to Update
...
export type MicrosoftEntraV1UserUpdateOutput = {
  updated?: boolean;
};

export type MicrosoftEntraV1UserUpdateNode = {
  type: 'n8n-nodes-base.microsoftEntra';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftEntraV1UserUpdateParams>;
  output?: Items<MicrosoftEntraV1UserUpdateOutput>;
};