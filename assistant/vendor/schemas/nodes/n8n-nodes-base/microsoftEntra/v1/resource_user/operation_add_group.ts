 ...
 * Discriminator: resource=user, operation=addGroup
 */
...
/** Add user to group */
export type MicrosoftEntraV1UserAddGroupParams = {
  resource: 'user';
  operation: 'addGroup';
/**
 * Group
...
export type MicrosoftEntraV1UserAddGroupNode = {
  type: 'n8n-nodes-base.microsoftEntra';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftEntraV1UserAddGroupParams>;
};