...
export type MicrosoftEntraV1UserGetAllParams = {
  resource: 'user';
  operation: 'getAll';
/**
...
export type MicrosoftEntraV1UserGetAllOutput = {
...
export type MicrosoftEntraV1UserGetAllNode = {
  type: 'n8n-nodes-base.microsoftEntra';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftEntraV1UserGetAllParams>;
  output?: Items<MicrosoftEntraV1UserGetAllOutput>;
};