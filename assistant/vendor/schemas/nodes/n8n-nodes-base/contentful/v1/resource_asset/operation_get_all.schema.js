...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      additionalFields: z.object({ equal: stringOrExpression.optional(), exclude: stringOrExpression.optional(), exist: stringOrExpression.optional(), select: stringOrExpression.optional(), include: stringOrExpression.optional(), notEqual: stringOrExpression.optional(), order: stringOrExpression.optional(), query: stringOrExpression.optional(), rawData: booleanOrExpression.optional() }).optional(),
    }).optional(),
  });
};