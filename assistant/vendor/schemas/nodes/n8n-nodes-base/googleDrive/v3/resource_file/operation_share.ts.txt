...
export type GoogleDriveV3FileShareParams = {
  resource: 'file';
  operation: 'share';
...
export type GoogleDriveV3FileShareOutput = {
...
export type GoogleDriveV3FileShareNode = {
  type: 'n8n-nodes-base.googleDrive';
  version: 3;
  credentials?: Credentials;
  config: NodeConfig<GoogleDriveV3FileShareParams>;
  output?: Items<GoogleDriveV3FileShareOutput>;
};