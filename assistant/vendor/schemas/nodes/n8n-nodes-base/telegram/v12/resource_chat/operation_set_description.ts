 ...
 * Discriminator: resource=chat, operation=setDescription
 */
...
export type TelegramV12ChatSetDescriptionParams = {
  resource: 'chat';
...
export type TelegramV12ChatSetDescriptionNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12ChatSetDescriptionParams>;
};