 ...
 * Discriminator: resource=chat, operation=setTitle
 */
...
export type TelegramV12ChatSetTitleParams = {
  resource: 'chat';
  operation: 'setTitle';
/**
...
export type TelegramV12ChatSetTitleNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12ChatSetTitleParams>;
};