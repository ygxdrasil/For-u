 ...
 * Discriminator: resource=message, operation=unpinChatMessage
 */
...
export type TelegramV12MessageUnpinChatMessageParams = {
  resource: 'message';
...
export type TelegramV12MessageUnpinChatMessageNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12MessageUnpinChatMessageParams>;
};