 ...
 * Discriminator: resource=message, operation=sendAudio
 */
...
/** Send a audio file */
export type TelegramV12MessageSendAudioParams = {
  resource: 'message';
  operation: 'sendAudio';
/**
...
export type TelegramV12MessageSendAudioOutput = {
  ok?: boolean;
  result?: {
    audio?: {
      duration?: number;
...
export type TelegramV12MessageSendAudioNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12MessageSendAudioParams>;
  output?: Items<TelegramV12MessageSendAudioOutput>;
};