 ...
 * Discriminator: resource=message, operation=pinChatMessage
 */
...
/** Pin a chat message */
export type TelegramV12MessagePinChatMessageParams = {
  resource: 'message';
...
export type TelegramV12MessagePinChatMessageOutput = {
  ok?: boolean;
  result?: boolean;
};

export type TelegramV12MessagePinChatMessageNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12MessagePinChatMessageParams>;
  output?: Items<TelegramV12MessagePinChatMessageOutput>;
};