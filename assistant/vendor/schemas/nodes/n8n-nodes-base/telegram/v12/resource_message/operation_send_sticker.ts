...
/** Send a sticker */
export type TelegramV12MessageSendStickerParams = {
  resource: 'message';
...
export type TelegramV12MessageSendStickerOutput = {
  ok?: boolean;
  result?: {
    chat?: {
      first_name?: string;
...
export type TelegramV12MessageSendStickerNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12MessageSendStickerParams>;
  output?: Items<TelegramV12MessageSendStickerOutput>;
};