...
/** Send a chat action */
export type TelegramV12MessageSendChatActionParams = {
  resource: 'message';
...
export type TelegramV12MessageSendChatActionOutput = {
  ok?: boolean;
  result?: boolean;
};

export type TelegramV12MessageSendChatActionNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12MessageSendChatActionParams>;
  output?: Items<TelegramV12MessageSendChatActionOutput>;
};