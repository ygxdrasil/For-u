...
export type TelegramV12MessageSendMediaGroupParams = {
  resource: 'message';
 ...
 */
    ...
    media?: Array<{
       ...
       */
      media?: string | Expression<string> | PlaceholderValue;
      /** Additional Fields
       * @default {}
       */
      additionalFields?: {
 ...
 */
    ...
    /** How to parse the text
     * @displayOptions.show { /operation: ["editMessageText", "sendAnimation", "sendAudio", "sendMessage", "sendPhoto", "sendVideo", "sendDocument"] }
     * @default HTML
     */
    parse_mode?: 'Markdown' | 'MarkdownV2' | 'HTML' | Expression<string>;
...
export type TelegramV12MessageSendMediaGroupOutput = {
  ok?: boolean;
  result?: Array<{
    caption?: string;
    chat?: {
...
export type TelegramV12MessageSendMediaGroupNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12MessageSendMediaGroupParams>;
  output?: Items<TelegramV12MessageSendMediaGroupOutput>;
};