 ...
 * Discriminator: resource=message, operation=sendPhoto
 */
...
/** Send a photo */
export type TelegramV12MessageSendPhotoParams = {
  resource: 'message';
  operation: 'sendPhoto';
/**
...
export type TelegramV12MessageSendPhotoOutput = {
  ok?: boolean;
  result?: {
    caption?: string;
    chat?: {
...
export type TelegramV12MessageSendPhotoNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12MessageSendPhotoParams>;
  output?: Items<TelegramV12MessageSendPhotoOutput>;
};