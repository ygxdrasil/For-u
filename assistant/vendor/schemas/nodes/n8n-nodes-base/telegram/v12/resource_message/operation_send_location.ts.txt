 ...
 * Discriminator: resource=message, operation=sendLocation
 */
...
/** Send a location */
export type TelegramV12MessageSendLocationParams = {
  resource: 'message';
...
export type TelegramV12MessageSendLocationOutput = {
  ok?: boolean;
  result?: {
    chat?: {
      first_name?: string;
...
export type TelegramV12MessageSendLocationNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12MessageSendLocationParams>;
  output?: Items<TelegramV12MessageSendLocationOutput>;
};