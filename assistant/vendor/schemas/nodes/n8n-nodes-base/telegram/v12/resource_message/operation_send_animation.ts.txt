 ...
 * Discriminator: resource=message, operation=sendAnimation
 */
...
export type TelegramV12MessageSendAnimationParams = {
  resource: 'message';
...
export type TelegramV12MessageSendAnimationOutput = {
  ok?: boolean;
  result?: {
    animation?: {
      duration?: number;
...
export type TelegramV12MessageSendAnimationNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12MessageSendAnimationParams>;
  output?: Items<TelegramV12MessageSendAnimationOutput>;
};