 ...
 * Discriminator: resource=message, operation=sendDocument
 */
...
/** Send a document */
export type TelegramV12MessageSendDocumentParams = {
  resource: 'message';
...
export type TelegramV12MessageSendDocumentOutput = {
  ok?: boolean;
  result?: {
    chat?: {
      first_name?: string;
...
export type TelegramV12MessageSendDocumentNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12MessageSendDocumentParams>;
  output?: Items<TelegramV12MessageSendDocumentOutput>;
};