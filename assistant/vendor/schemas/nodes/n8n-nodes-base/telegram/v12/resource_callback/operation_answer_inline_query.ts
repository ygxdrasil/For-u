 ...
 * Discriminator: resource=callback, operation=answerInlineQuery
 */
...
export type TelegramV12CallbackAnswerInlineQueryParams = {
  resource: 'callback';
 ...
 */
    results?: string | Expression<string> | PlaceholderValue;
/**
 * Additional Fields
 * @default {}
 */
...
export type TelegramV12CallbackAnswerInlineQueryNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<TelegramV12CallbackAnswerInlineQueryParams>;
};