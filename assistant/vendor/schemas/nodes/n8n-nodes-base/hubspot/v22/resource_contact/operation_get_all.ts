...
/** Get many contacts */
export type HubspotV22ContactGetAllParams = {
  resource: 'contact';
  operation: 'getAll';
...
export type HubspotV22ContactGetAllNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV22ContactGetAllParams>;
  output?: Items<HubspotV22ContactGetAllOutput>;
};