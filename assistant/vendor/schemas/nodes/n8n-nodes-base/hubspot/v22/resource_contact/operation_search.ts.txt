...
/** Search contacts */
export type HubspotV22ContactSearchParams = {
  resource: 'contact';
  operation: 'search';
...
export type HubspotV22ContactSearchNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV22ContactSearchParams>;
  output?: Items<HubspotV22ContactSearchOutput>;
};