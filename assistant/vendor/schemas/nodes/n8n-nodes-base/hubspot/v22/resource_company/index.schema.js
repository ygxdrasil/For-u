/**
 * HubSpot - Company Resource - Zod Schema Factory
...
const getGetRecentlyCreatedUpdatedSchema = require('./operation_get_recently_created_updated.schema');
const getSearchByDomainSchema = require('./operation_search_by_domain.schema');
