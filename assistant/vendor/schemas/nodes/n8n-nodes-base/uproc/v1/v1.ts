 ...
 */
    credit_card?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    coordinates?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    ean?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    asin?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    language?: 'american' | 'arabic' | 'bengali' | 'british' | 'czech' | 'danish' | 'dutch' | 'filipino' | 'finnish' | 'french' | 'german' | 'greek' | 'gujurati' | 'hindi' | 'hungarian' | 'indonesian' | 'italian' | 'japanese' | 'kannada' | 'korean' | 'malayalam' | 'mandarin' | 'norwegian' | 'polish' | 'portuguese' | 'russian' | 'slovak' | 'spanish' | 'tamil' | 'telugu' | 'thai' | 'turkish' | 'ukranian' | 'vietnamese' | Expression<string>;
/**
 ...
 */
    isocode?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    isbn?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    publisher?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    dni?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    cif?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    nie?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    nif?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    uuid?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    duns?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    taxid?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    area?: 'Communications' | 'Consulting' | 'Customer service' | 'Education' | 'Engineering' | 'Finance' | 'Health professional' | 'Human resources' | 'Information technology' | 'Legal' | 'Marketing' | 'Operations' | 'Owner' | 'President' | 'Product' | 'Public relations' | 'Real estate' | 'Recruiting' | 'Research' | 'Sales' | Expression<string>;
/**
 ...
 */
    fuel_consumption?: string | Expression<string> | PlaceholderValue;
/**
 * The "Price liter" value to use as a parameter for this Operation
 * @displayOptions.show { group: ["geographic", "geographic"], tool: ["getRouteByAddresses", "getRouteByIps"] }
 */
    price_liter?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    coordinates1?: string | Expression<string> | PlaceholderValue;
/**
 * The "Coordinates2" value to use as a parameter for this Operation
 * @displayOptions.show { group: ["geographic", "geographic", "geographic", "geographic", "geographic", "geographic", "geographic"], tool: ["getDistanceByCoordinates", "getRouteByCoordinates", "checkDistanceEq", "checkDistanceGe", "checkDistanceGt", "checkDistanceLe", "checkDistanceLt"] }
 */
    coordinates2?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    ip1?: string | Expression<string> | PlaceholderValue;
/**
 * The "Ip2" value to use as a parameter for this Operation
 * @displayOptions.show { group: ["geographic", "geographic"], tool: ["getDistanceByIps", "getRouteByIps"] }
 */
    ip2?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    phone1?: string | Expression<string> | PlaceholderValue;
/**
 * The "Phone2" value to use as a parameter for this Operation
 * @displayOptions.show { group: ["geographic", "geographic"], tool: ["getDistanceByPhones", "getRouteByPhones"] }
 */
    phone2?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    zipcode1?: string | Expression<string> | PlaceholderValue;
/**
 * The "Zipcode2" value to use as a parameter for this Operation
 * @displayOptions.show { group: ["geographic", "geographic"], tool: ["getDistanceByZipcodes", "getRouteByZipcodes"] }
 */
    zipcode2?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    distance?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    isocode1?: 'AUD' | 'BGN' | 'BRL' | 'CAD' | 'CHF' | 'CNY' | 'CZK' | 'DKK' | 'EUR' | 'GBP' | 'HKD' | 'HRK' | 'HUF' | 'IDR' | 'ILS' | 'INR' | 'ISK' | 'JPY' | 'KRW' | 'MXN' | 'MYR' | 'NOK' | 'NZD' | 'PHP' | 'PLN' | 'RON' | 'RUB' | 'SEK' | 'SGD' | 'THB' | 'TRY' | 'USD' | 'ZAR' | Expression<string>;
/**
 * The "Isocode2" value to use as a parameter for this Operation
 * @displayOptions.show { group: ["finance"], tool: ["getCurrencyConvertedBetweenIsocodeDate"] }
 */
    isocode2?: 'AUD' | 'BGN' | 'BRL' | 'CAD' | 'CHF' | 'CNY' | 'CZK' | 'DKK' | 'EUR' | 'GBP' | 'HKD' | 'HRK' | 'HUF' | 'IDR' | 'ILS' | 'INR' | 'ISK' | 'JPY' | 'KRW' | 'MXN' | 'MYR' | 'NOK' | 'NZD' | 'PHP' | 'PLN' | 'RON' | 'RUB' | 'SEK' | 'SGD' | 'THB' | 'TRY' | 'USD' | 'ZAR' | Expression<string>;
/**
 ...
 */
    useragent?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    selector?: string | Expression<string> | PlaceholderValue;
/**
 * The "Delay" value to use as a parameter for this Operation
 * @displayOptions.show { group: ["image"], tool: ["getUrlScreenshot"] }
 */
    delay?: string | Expression<string> | PlaceholderValue;
/**
 * The "Viewport" value to use as a parameter for this Operation
 * @displayOptions.show { group: ["image"], tool: ["getUrlScreenshot"] }
 */
    viewport?: string | Expression<string> | PlaceholderValue;
/**
 ...
 * @displayOptions.show { group: ["communication"], tool: ["sendEmailCustom"] }
 */
    email_to?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    url_dlr?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    port?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    locality?: 'Australia (English)' | 'Australia Ocker (English)' | 'Azerbaijani' | 'Bork (English)' | 'Canada (English)' | 'Canada (French)' | 'Chinese' | 'Chinese (Taiwan)' | 'Czech' | 'Dutch' | 'English' | 'Farsi' | 'French' | 'Georgian' | 'German' | 'German (Austria)' | 'German (Switzerland)' | 'Great Britain (English)' | 'India (English)' | 'Indonesia' | 'Ireland (English)' | 'Italian' | 'Japanese' | 'Korean' | 'Nepalese' | 'Norwegian' | 'Polish' | 'Portuguese (Brazil)' | 'Russian' | 'Slovakian' | 'Spanish' | 'Spanish Mexico' | 'Swedish' | 'Turkish' | 'Ukrainian' | 'United States (English)' | 'Vietnamese' | Expression<string>;
/**
 ...
 */
    format?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    text1?: string | Expression<string> | PlaceholderValue;
/**
 * The "Text2" value to use as a parameter for this Operation
 * @displayOptions.show { group: ["text", "text", "text", "text"], tool: ["checkStringContains", "checkStringEnds", "getStringJoin", "checkStringStarts"] }
 */
    text2?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    glue?: string | Expression<string> | PlaceholderValue;
/**
 * The "Field" value to use as a parameter for this Operation
 * @displayOptions.show { group: ["text"], tool: ["getStringNormalized"] }
 */
    field?: 'alphabetic' | 'alphanumeric' | 'cif' | 'city' | 'country' | 'date' | 'decimal' | 'dni' | 'domain' | 'email' | 'gender' | 'integer' | 'ip' | 'mobile' | 'name' | 'nie' | 'nif' | 'phone' | 'province' | 'zipcode' | Expression<string>;
/**
 ...
 */
    tin?: string | Expression<string> | PlaceholderValue;
/**
 ...
 */
    count?: string | Expression<string> | PlaceholderValue;
/**
 * Additional Options
 * @displayOptions.show { group: ["audio", "communication", "company", "finance", "geographic", "image", "internet", "personal", "product", "security", "text"] }
 * @default {}
 */
    additionalOptions?: {
    /** URL to send tool response when tool has resolved your request
     */
    dataWebhook?: string | Expression<string> | PlaceholderValue;
  };
}
