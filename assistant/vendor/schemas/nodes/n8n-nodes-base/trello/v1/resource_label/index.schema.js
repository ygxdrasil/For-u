/**
 * Trello - Label Resource - Zod Schema Factory
...
const getAddLabelSchema = require('./operation_add_label.schema');
...
const getRemoveLabelSchema = require('./operation_remove_label.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    getAddLabelSchema({ ...helpers, parameters: effectiveParams }),
    getCreateSchema({ ...helpers, parameters: effectiveParams }),
    getDeleteSchema({ ...helpers, parameters: effectiveParams }),
    getGetSchema({ ...helpers, parameters: effectiveParams }),
    getGetAllSchema({ ...helpers, parameters: effectiveParams }),
    getRemoveLabelSchema({ ...helpers, parameters: effectiveParams }),
