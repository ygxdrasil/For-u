/**
 * Webhook Node - Version 1.1
 * Starts the workflow when a webhook is called
 */


export interface WebhookV11Params {
/**
...
export interface WebhookV11Credentials {
  httpBasicAuth: CredentialReference;
  httpHeaderAuth: CredentialReference;
  jwtAuth: CredentialReference;
}

interface WebhookV11NodeBase {
  type: 'n8n-nodes-base.webhook';
  version: 1.1;
  credentials?: WebhookV11Credentials;
  isTrigger: true;
}

export type WebhookV11ParamsNode = WebhookV11NodeBase & {
  config: NodeConfig<WebhookV11Params>;
};

export type WebhookV11Node = WebhookV11ParamsNode;