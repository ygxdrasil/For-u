/**
 * Elastic Security - Case Resource - Zod Schema Factory
...
const getGetStatusSchema = require('./operation_get_status.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getGetStatusSchema({ ...helpers, parameters: effectiveParams }),
