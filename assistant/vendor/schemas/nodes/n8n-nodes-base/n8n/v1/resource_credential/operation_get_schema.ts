/**
 * n8n Node - Version 1
 * Discriminator: resource=credential, operation=getSchema
 */
...
export type N8nV1CredentialGetSchemaParams = {
  resource: 'credential';
  operation: 'getSchema';
/**
...
export type N8nV1CredentialGetSchemaNode = {
  type: 'n8n-nodes-base.n8n';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<N8nV1CredentialGetSchemaParams>;
};