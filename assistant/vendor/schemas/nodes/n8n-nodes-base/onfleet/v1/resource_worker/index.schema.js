/**
 * Onfleet - Worker Resource - Zod Schema Factory
...
const getGetScheduleSchema = require('./operation_get_schedule.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getGetScheduleSchema({ ...helpers, parameters: effectiveParams }),
