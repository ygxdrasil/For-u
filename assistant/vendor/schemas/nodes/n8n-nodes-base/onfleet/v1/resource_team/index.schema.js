/**
 * Onfleet - Team Resource - Zod Schema Factory
...
const getAutoDispatchSchema = require('./operation_auto_dispatch.schema');
...
const getGetTimeEstimatesSchema = require('./operation_get_time_estimates.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    getAutoDispatchSchema({ ...helpers, parameters: effectiveParams }),
    getCreateSchema({ ...helpers, parameters: effectiveParams }),
    getDeleteSchema({ ...helpers, parameters: effectiveParams }),
    getGetSchema({ ...helpers, parameters: effectiveParams }),
    getGetAllSchema({ ...helpers, parameters: effectiveParams }),
    getGetTimeEstimatesSchema({ ...helpers, parameters: effectiveParams }),
