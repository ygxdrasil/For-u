// ../../../../tmp/claude-0/-home-user-For-u/0e645656-0d7d-5e05-bba0-bc0cbe899eb0/scratchpad/nodesrc/node_modules/n8n-nodes-base/dist/node-definitions/nodes/n8n-nodes-base/timescaleDb/v1.schema.js
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema }) {
  const parametersSchema = z.object({
    operation: z.union([z.literal("executeQuery"), z.literal("insert"), z.literal("update"), expressionSchema]).optional(),
    ...
    additionalFields: z.object({ mode: z.union([z.literal("independently"), z.literal("multiple"), z.literal("transaction"), expressionSchema]).optional(), queryParams: stringOrExpression.optional() }).optional()
  });
  return z.object({
