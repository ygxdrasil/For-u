...
export type ConvertKitV1FormGetSubscriptionsParams = {
  resource: 'form';
...
export type ConvertKitV1FormGetSubscriptionsNode = {
  type: 'n8n-nodes-base.convertKit';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<ConvertKitV1FormGetSubscriptionsParams>;
};