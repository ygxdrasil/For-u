/**
 * Mailchimp Node - Version 1 - Zod Schema Factory
...
const getListGroupSchema = require('./resource_list_group/index.schema');
const getMemberSchema = require('./resource_member/index.schema');
const getMemberTagSchema = require('./resource_member_tag/index.schema');

module.exports = function getSchema(helpers) {
  const { parameters, z } = helpers;
  // Apply discriminator default if not set
  const effectiveParams = parameters.resource === undefined ? { ...parameters, resource: 'member' } : parameters;
  return z.union([
