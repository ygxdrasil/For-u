/**
 * Invoice Ninja - BankTransaction Resource - Zod Schema Factory
...
const getMatchPaymentSchema = require('./operation_match_payment.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getMatchPaymentSchema({ ...helpers, parameters: effectiveParams }),
  ]);
};