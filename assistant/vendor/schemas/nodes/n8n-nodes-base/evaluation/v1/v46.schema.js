/**
 * Evaluation Node - Version 4.6 - Zod Validation Schemas
 *
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, languageModelInstanceSchema }) {
  ...
  const parametersSchema = z.object({
    ...
    metric: resolveSchema({ parameters, schema: z.unknown(), required: false, displayOptions: {"show":{"operation":["setMetrics"]}}, defaults: {"operation":"setOutputs"} }),
    expectedAnswer: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["correctness","stringSimilarity","categorization"]}}, defaults: {"operation":"setOutputs","metric":"customMetrics"} }),
    actualAnswer: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["correctness","stringSimilarity","categorization","helpfulness"]}}, defaults: {"operation":"setOutputs","metric":"customMetrics"} }),
    userQuery: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["helpfulness"]}}, defaults: {"operation":"setOutputs","metric":"customMetrics"} }),
    expectedTools: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["toolsUsed"]}}, defaults: {"operation":"setOutputs","metric":"customMetrics"} }),
    intermediateSteps: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["toolsUsed"]}}, defaults: {"operation":"setOutputs","metric":"customMetrics"} }),
    prompt: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["correctness","helpfulness"]}}, defaults: {"operation":"setOutputs","metric":"customMetrics"} }),
    metrics: resolveSchema({ parameters, schema: assignmentCollectionValueSchema, required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["customMetrics"]}}, defaults: {"operation":"setOutputs","metric":"customMetrics"} }),
    options: resolveSchema({ parameters, schema: z.object({ metricName: stringOrExpression.optional(), inputPrompt: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["correctness","helpfulness","categorization","stringSimilarity","toolsUsed"]}}, defaults: {"operation":"setOutputs","metric":"customMetrics"} }),
  });
