...
export interface EvaluationV47SubnodeConfig {
  model?: LanguageModelInstance | LanguageModelInstance[];
}

export interface EvaluationV47Credentials {
  googleApi: CredentialReference;
  googleSheetsOAuth2Api: CredentialReference;
}

interface EvaluationV47NodeBase {
...
export type EvaluationV47ParamsNode = EvaluationV47NodeBase & {
  config: NodeConfig<EvaluationV47Params> & { subnodes?: EvaluationV47SubnodeConfig };
};
