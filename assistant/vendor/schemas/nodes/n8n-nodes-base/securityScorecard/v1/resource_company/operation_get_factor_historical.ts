 ...
 * Discriminator: resource=company, operation=getFactorHistorical
 */
...
export type SecurityScorecardV1CompanyGetFactorHistoricalParams = {
  resource: 'company';
...
export type SecurityScorecardV1CompanyGetFactorHistoricalNode = {
  type: 'n8n-nodes-base.securityScorecard';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<SecurityScorecardV1CompanyGetFactorHistoricalParams>;
};