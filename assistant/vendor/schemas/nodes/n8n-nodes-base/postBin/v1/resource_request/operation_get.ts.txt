 ...
 * Discriminator: resource=request, operation=get
 */


/** Get a bin */
export type PostBinV1RequestGetParams = {
  resource: 'request';
  operation: 'get';
/**
...
export type PostBinV1RequestGetNode = {
  type: 'n8n-nodes-base.postBin';
  version: 1;
  config: NodeConfig<PostBinV1RequestGetParams>;
};