/**
 * MISP - Event Resource - Zod Schema Factory
...
const getPublishSchema = require('./operation_publish.schema');
const getSearchSchema = require('./operation_search.schema');
const getUnpublishSchema = require('./operation_unpublish.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getPublishSchema({ ...helpers, parameters: effectiveParams }),
    getSearchSchema({ ...helpers, parameters: effectiveParams }),
    getUnpublishSchema({ ...helpers, parameters: effectiveParams }),
