/**
 * MISP Node - Version 1
 * Discriminator: resource=event, operation=search
 */
...
export type MispV1EventSearchParams = {
  resource: 'event';
  operation: 'search';
/**
...
export type MispV1EventSearchNode = {
  type: 'n8n-nodes-base.misp';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<MispV1EventSearchParams>;
};