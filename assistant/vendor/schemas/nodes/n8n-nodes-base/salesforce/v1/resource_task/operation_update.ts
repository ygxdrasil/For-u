...
export type SalesforceV1TaskUpdateParams = {
  resource: 'task';
  operation: 'update';
/**
...
export type SalesforceV1TaskUpdateNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<SalesforceV1TaskUpdateParams>;
  output?: Items<SalesforceV1TaskUpdateOutput>;
};