...
export type SalesforceV1AttachmentGetAllParams = {
  resource: 'attachment';
  operation: 'getAll';
/**
...
export type SalesforceV1AttachmentGetAllNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<SalesforceV1AttachmentGetAllParams>;
  output?: Items<SalesforceV1AttachmentGetAllOutput>;
};