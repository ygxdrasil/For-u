...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      reminderUpdateFields: z.object({ due: z.unknown().optional(), type: z.union([z.literal('absolute'), z.literal('relative'), expressionSchema]).optional(), minute_offset: numberOrExpression.optional(), notify_uid: stringOrExpression.optional() }).optional(),
    }).optional(),
  });
};