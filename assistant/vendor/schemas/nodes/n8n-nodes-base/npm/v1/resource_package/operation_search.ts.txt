/**
 * Npm Node - Version 1
 * Discriminator: resource=package, operation=search
 */
...
/** Search for packages */
export type NpmV1PackageSearchParams = {
  resource: 'package';
  operation: 'search';
/**
...
export type NpmV1PackageSearchNode = {
  type: 'n8n-nodes-base.npm';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<NpmV1PackageSearchParams>;
};