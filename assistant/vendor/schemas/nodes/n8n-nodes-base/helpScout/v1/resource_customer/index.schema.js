/**
 * Help Scout - Customer Resource - Zod Schema Factory
...
const getPropertiesSchema = require('./operation_properties.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getPropertiesSchema({ ...helpers, parameters: effectiveParams }),
