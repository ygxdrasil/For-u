 ...
 * Discriminator: resource=dictionary, operation=getAll
 */
...
export type ServiceNowV1DictionaryGetAllParams = {
  resource: 'dictionary';
  operation: 'getAll';
/**
...
export type ServiceNowV1DictionaryGetAllNode = {
  type: 'n8n-nodes-base.serviceNow';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<ServiceNowV1DictionaryGetAllParams>;
};