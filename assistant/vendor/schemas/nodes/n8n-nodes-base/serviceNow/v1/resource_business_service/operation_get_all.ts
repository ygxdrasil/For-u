 ...
 * Discriminator: resource=businessService, operation=getAll
 */
...
export type ServiceNowV1BusinessServiceGetAllParams = {
...
export type ServiceNowV1BusinessServiceGetAllNode = {
  type: 'n8n-nodes-base.serviceNow';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<ServiceNowV1BusinessServiceGetAllParams>;
};