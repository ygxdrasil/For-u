 ...
 * Discriminator: resource=userRole, operation=getAll
 */
...
export type ServiceNowV1UserRoleGetAllParams = {
  resource: 'userRole';
  operation: 'getAll';
/**
...
export type ServiceNowV1UserRoleGetAllNode = {
  type: 'n8n-nodes-base.serviceNow';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<ServiceNowV1UserRoleGetAllParams>;
};