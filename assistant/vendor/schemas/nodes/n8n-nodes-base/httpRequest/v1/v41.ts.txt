/**
 * HTTP Request Node - Version 4.1
 * Makes an HTTP request and returns the response data
 */


export interface HttpRequestV41Params {
/**
...
export interface HttpRequestV41Credentials {
...
interface HttpRequestV41NodeBase {
  type: 'n8n-nodes-base.httpRequest';
  version: 4.1;
  credentials?: HttpRequestV41Credentials;
}

export type HttpRequestV41ParamsNode = HttpRequestV41NodeBase & {
  config: NodeConfig<HttpRequestV41Params>;
};

export type HttpRequestV41Node = HttpRequestV41ParamsNode;