...
export interface HttpRequestV4Params {
/**
...
export interface HttpRequestV4Credentials {
...
export type HttpRequestV4ParamsNode = HttpRequestV4NodeBase & {
  config: NodeConfig<HttpRequestV4Params>;
};

export type HttpRequestV4Node = HttpRequestV4ParamsNode;