...
interface HttpRequestV42NodeBase {
  type: 'n8n-nodes-base.httpRequest';
  version: 4.2;
  credentials?: HttpRequestV42Credentials;
}

export type HttpRequestV42ParamsNode = HttpRequestV42NodeBase & {
  config: NodeConfig<HttpRequestV42Params>;
};

export type HttpRequestV42Node = HttpRequestV42ParamsNode;