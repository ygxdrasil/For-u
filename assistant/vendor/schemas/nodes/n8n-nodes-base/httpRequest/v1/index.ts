...
import type { HttpRequestV44Node } from './v44';
...
export type HttpRequestNode = HttpRequestV44Node | HttpRequestV43Node | HttpRequestV42Node | HttpRequestV41Node | HttpRequestV4Node | HttpRequestV3Node | HttpRequestV2Node | HttpRequestV1Node;