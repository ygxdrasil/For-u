...
export interface HttpRequestV43Params {
/**
...
export type HttpRequestV43ParamsNode = HttpRequestV43NodeBase & {
  config: NodeConfig<HttpRequestV43Params>;
};

export type HttpRequestV43Node = HttpRequestV43ParamsNode;