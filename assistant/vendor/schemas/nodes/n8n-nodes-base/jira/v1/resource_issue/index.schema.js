/**
 * Jira Software - Issue Resource - Zod Schema Factory
...
const getChangelogSchema = require('./operation_changelog.schema');
...
const getNotifySchema = require('./operation_notify.schema');
const getTransitionsSchema = require('./operation_transitions.schema');
