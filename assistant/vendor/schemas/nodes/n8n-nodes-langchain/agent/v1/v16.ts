...
export interface LcAgentV16Params {
/**
 * Agent
 * @default toolsAgent
 */
...
export interface LcAgentV16SubnodeConfig {
...
export type LcAgentV16ParamsNode = LcAgentV16NodeBase & {
  config: NodeConfig<LcAgentV16Params> & { credentials?: LcAgentV16Credentials } & { subnodes: LcAgentV16SubnodeConfig };
};

export type LcAgentV16Node = LcAgentV16ParamsNode;