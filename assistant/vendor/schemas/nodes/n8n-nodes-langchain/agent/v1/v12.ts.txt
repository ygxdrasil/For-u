...
export interface LcAgentV12Params {
/**
 * Agent
...
export interface LcAgentV12SubnodeConfig {
...
export type LcAgentV12ParamsNode = LcAgentV12NodeBase & {
  config: NodeConfig<LcAgentV12Params> & { credentials?: LcAgentV12Credentials } & { subnodes: LcAgentV12SubnodeConfig };
};

export type LcAgentV12Node = LcAgentV12ParamsNode;