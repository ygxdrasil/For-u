...
export interface LcAgentV22Params {
...
export interface LcAgentV22SubnodeConfig {
...
export type LcAgentV22ParamsNode = LcAgentV22NodeBase & {
  config: NodeConfig<LcAgentV22Params> & { subnodes: LcAgentV22SubnodeConfig };
};

export type LcAgentV22Node = LcAgentV22ParamsNode;