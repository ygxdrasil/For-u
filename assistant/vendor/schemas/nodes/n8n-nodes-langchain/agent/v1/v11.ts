...
export interface LcAgentV11Params {
/**
 * Agent
...
export interface LcAgentV11SubnodeConfig {
...
export type LcAgentV11ParamsNode = LcAgentV11NodeBase & {
  config: NodeConfig<LcAgentV11Params> & { credentials?: LcAgentV11Credentials } & { subnodes: LcAgentV11SubnodeConfig };
};

export type LcAgentV11Node = LcAgentV11ParamsNode;