...
export interface LcAgentV17Params {
/**
 * Agent
 * @default toolsAgent
 */
    agent?: 'toolsAgent' | 'conversationalAgent' | 'openAiFunctionsAgent' | 'planAndExecuteAgent' | 'reActAgent' | 'sqlAgent';
/**
...
export interface LcAgentV17SubnodeConfig {
...
export type LcAgentV17ParamsNode = LcAgentV17NodeBase & {
  config: NodeConfig<LcAgentV17Params> & { credentials?: LcAgentV17Credentials } & { subnodes: LcAgentV17SubnodeConfig };
};

export type LcAgentV17Node = LcAgentV17ParamsNode;