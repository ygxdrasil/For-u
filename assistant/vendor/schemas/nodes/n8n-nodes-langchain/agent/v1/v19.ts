...
export interface LcAgentV19Params {
/**
 * Agent
 * @default toolsAgent
 */
...
export interface LcAgentV19SubnodeConfig {
...
export type LcAgentV19ParamsNode = LcAgentV19NodeBase & {
  config: NodeConfig<LcAgentV19Params> & { credentials?: LcAgentV19Credentials } & { subnodes: LcAgentV19SubnodeConfig };
};

export type LcAgentV19Node = LcAgentV19ParamsNode;