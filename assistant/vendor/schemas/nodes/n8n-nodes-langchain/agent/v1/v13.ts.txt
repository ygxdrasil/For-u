...
export interface LcAgentV13Params {
/**
 * Agent
...
export interface LcAgentV13SubnodeConfig {
...
export type LcAgentV13ParamsNode = LcAgentV13NodeBase & {
  config: NodeConfig<LcAgentV13Params> & { credentials?: LcAgentV13Credentials } & { subnodes: LcAgentV13SubnodeConfig };
};

export type LcAgentV13Node = LcAgentV13ParamsNode;