...
export interface LcAgentV21Params {
...
export interface LcAgentV21SubnodeConfig {
...
export type LcAgentV21ParamsNode = LcAgentV21NodeBase & {
  config: NodeConfig<LcAgentV21Params> & { subnodes: LcAgentV21SubnodeConfig };
};

export type LcAgentV21Node = LcAgentV21ParamsNode;