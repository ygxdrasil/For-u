...
export interface LcAgentV1Params {
/**
 * Agent
...
export interface LcAgentV1SubnodeConfig {
...
export type LcAgentV1ParamsNode = LcAgentV1NodeBase & {
  config: NodeConfig<LcAgentV1Params> & { credentials?: LcAgentV1Credentials } & { subnodes: LcAgentV1SubnodeConfig };
};

export type LcAgentV1Node = LcAgentV1ParamsNode;