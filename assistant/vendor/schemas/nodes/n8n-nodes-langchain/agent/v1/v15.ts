...
export interface LcAgentV15Params {
/**
 * Agent
...
export interface LcAgentV15SubnodeConfig {
...
export type LcAgentV15ParamsNode = LcAgentV15NodeBase & {
  config: NodeConfig<LcAgentV15Params> & { credentials?: LcAgentV15Credentials } & { subnodes: LcAgentV15SubnodeConfig };
};

export type LcAgentV15Node = LcAgentV15ParamsNode;