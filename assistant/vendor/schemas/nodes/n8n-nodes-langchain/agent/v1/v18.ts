...
export type LcAgentV18ParamsNode = LcAgentV18NodeBase & {
  config: NodeConfig<LcAgentV18Params> & { credentials?: LcAgentV18Credentials } & { subnodes: LcAgentV18SubnodeConfig };
};
