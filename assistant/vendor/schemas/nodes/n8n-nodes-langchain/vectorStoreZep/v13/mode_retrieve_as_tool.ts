...
export type LcVectorStoreZepV13RetrieveAsToolParams = {
  /**
...
export interface LcVectorStoreZepV13RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreZepV13RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreZep';
  version: 1.3;
  config: NodeConfig<LcVectorStoreZepV13RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreZepV13RetrieveAsToolSubnodeConfig };
};