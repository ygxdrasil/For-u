...
export type LcVectorStorePineconeV13RetrieveAsToolParams = {
  /**
...
export interface LcVectorStorePineconeV13RetrieveAsToolSubnodeConfig {
...
export type LcVectorStorePineconeV13RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePinecone';
  version: 1.3;
  config: NodeConfig<LcVectorStorePineconeV13RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStorePineconeV13RetrieveAsToolSubnodeConfig };
};