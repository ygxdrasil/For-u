...
export type LcVectorStoreChromaDBV13InsertParams = {
  /**
...
export interface LcVectorStoreChromaDBV13InsertSubnodeConfig {
  embedding: EmbeddingInstance | EmbeddingInstance[];
  documentLoader: DocumentLoaderInstance | DocumentLoaderInstance[];
}

export type LcVectorStoreChromaDBV13InsertNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreChromaDB';
  version: 1.3;
  config: NodeConfig<LcVectorStoreChromaDBV13InsertParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreChromaDBV13InsertSubnodeConfig };
};