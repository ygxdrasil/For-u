...
export interface LcVectorStoreAzureAISearchV13RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreAzureAISearchV13RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreAzureAISearch';
  version: 1.3;
  config: NodeConfig<LcVectorStoreAzureAISearchV13RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreAzureAISearchV13RetrieveAsToolSubnodeConfig };
};