/**
 * MCP Client Tool Node - Version 1.4
 * Connect tools from an MCP Server
 */


export interface LcMcpClientToolV14Params {
/**
...
export interface LcMcpClientToolV14Credentials {
...
interface LcMcpClientToolV14NodeBase {
  type: '@n8n/n8n-nodes-langchain.mcpClientTool';
  version: 1.4;
}

export type LcMcpClientToolV14ParamsNode = LcMcpClientToolV14NodeBase & {
  config: NodeConfig<LcMcpClientToolV14Params> & { credentials?: LcMcpClientToolV14Credentials };
};

export type LcMcpClientToolV14Node = LcMcpClientToolV14ParamsNode;