/**
 * Chat Node - Version 1.2
 * Send a message into the chat
 */


export interface LcChatV12Params {
/**
 * Operation
 * @default send
 */
...
export interface LcChatV12SubnodeConfig {
  memory?: MemoryInstance;
}

interface LcChatV12NodeBase {
  type: '@n8n/n8n-nodes-langchain.chat';
  version: 1.2;
  isTrigger: true;
}

export type LcChatV12ParamsNode = LcChatV12NodeBase & {
  config: NodeConfig<LcChatV12Params> & { subnodes?: LcChatV12SubnodeConfig };
};

export type LcChatV12Node = LcChatV12ParamsNode;