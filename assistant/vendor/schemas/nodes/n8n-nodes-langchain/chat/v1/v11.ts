...
export interface LcChatV11SubnodeConfig {
  memory?: MemoryInstance;
}

interface LcChatV11NodeBase {
  type: '@n8n/n8n-nodes-langchain.chat';
  version: 1.1;
  isTrigger: true;
}

export type LcChatV11ParamsNode = LcChatV11NodeBase & {
  config: NodeConfig<LcChatV11Params> & { subnodes?: LcChatV11SubnodeConfig };
};

export type LcChatV11Node = LcChatV11ParamsNode;